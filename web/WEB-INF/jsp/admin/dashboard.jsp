...
<div style="margin-left: 210px">
    <br>
    <a href="${pageContext.request.contextPath}/admin/notices/add" class="layui-btn layui-btn-sm"><i class="layui-icon"></i></a>
    <br>
...
<script>
    ...
    layui.use('table', function () {
        table.render({
            elem: '#test'
            , url: '${pageContext.request.contextPath}/admin/notices'
            ...
            , cols: [[
                {field: 'nid', title: 'ID', fixed: 'left', unresize: true, sort: true}
                , {field: 'title', title: '公告标题', edit: 'text'}
                , {field: 'content', title: '公告', edit: 'text'}
        ...
        table.on('tool(test)', function (obj) {
                ...
                if (obj.event === 'del') {
                    layer.confirm('确定要删除吗？', function (index) {
                        obj.del();
                        layer.close(index);
                        axios("${pageContext.request.contextPath}/admin/notices/delete/" + data.nid).then((res) => {
